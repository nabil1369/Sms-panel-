...
try:
    ADMIN_ID = int(os.getenv("ADMIN_ID", "8875212514"))
except ValueError:
    raise RuntimeError("ADMIN_ID must be a valid Telegram numeric user ID")

BASE_URL = f"https://api.telegram.org/bot{BOT_TOKEN}/"
BOT_USERNAME = os.getenv("BOT_USERNAME", "@BD_SMS_HUB_BOT").strip()

# 2oo9 API Configuration
API_2OO9_BASE = "https://api.2oo9.cloud/MXS47FLFX0U/tnevs/@public/api"
API_2OO9_KEY_DEFAULT = os.getenv("API_2OO9_KEY", "").strip()
...
voltx_keys = [API_2OO9_KEY_DEFAULT] if API_2OO9_KEY_DEFAULT else []
...
# variable. This tiny HTTP server runs in a daemon thread and does not
# interfere with the Telegram long-polling loop below.
...
def start_render_health_server():
    try:
        ...
        print(f"Render health server could not start: {e}")
